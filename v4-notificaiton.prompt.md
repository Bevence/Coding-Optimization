...
- Run `graphify query "<question>"` or `graphify explain "<concept>"` to explore the codebase architecture, and run `graphify update .` after making file modifications to keep the graph current.
